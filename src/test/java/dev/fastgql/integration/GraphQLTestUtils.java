            ...
            response ->
                context.verify(
                    () -> {
                      ...
                      verifyQueryWithToken(port, query, expected, "", vertx, context);
                    }),
            context::failNow);
  }
...
//
   ...
   * @param context Vert.x test context
   */
  public static void verifyUnauthorizedQuery(int port, String host, String requestURI, Vertx vertx, VertxTestContext context) {
